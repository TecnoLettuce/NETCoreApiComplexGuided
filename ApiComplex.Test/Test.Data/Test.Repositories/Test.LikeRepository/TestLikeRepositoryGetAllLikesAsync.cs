...
{
    public class TestLikeRepositoryGetAllLikesAsync
    {
        private readonly ApiContext _context;

        [Fact]
        public void TestGetAllLikesAsyncResturnsSomething()
        {
            ...
            Task task = likeRepository.GetAllLikesAsync().ContinueWith(
                innserTask =>
                {
