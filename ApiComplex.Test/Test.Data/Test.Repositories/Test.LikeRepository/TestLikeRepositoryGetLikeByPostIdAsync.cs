...
{
    public class TestLikeRepositoryGetLikeByPostIdAsync
    {
        private readonly ApiContext _context;

        [Fact]
        public void TestGetLikeByPostIdAsyncResturnsSomething()
        {
            ...
            Task task = likeRepository.GetLikedByPostId(0).ContinueWith(
                innserTask =>
                {
