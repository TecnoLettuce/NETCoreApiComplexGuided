...
{
    public class TestPostRepositoryGetAllPostsByUserIdAsync
    {
        private readonly ApiContext _context;

        [Fact]
        public void TestPostRepositoryGetAllPostsByUserIdAsyncReturnsSomething()
        {
            ...
            Task task = postRepository.GetAllPostsByUserIdAsync(0).ContinueWith(
                innserTask =>
                {
