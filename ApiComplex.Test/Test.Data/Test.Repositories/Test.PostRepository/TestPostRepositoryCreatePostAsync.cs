...
{
    public class TestPostRepositoryCreatePostAsync
    {
        private readonly ApiContext _context;

        [Fact]
        public void TestPostRepositoryCreatePostAsyncReturnsSomething()
        {
            ...
            Task task2 = postRepository.GetPostByIdAsync(postToInsert.PostId).ContinueWith(
                innserTask =>
                {
