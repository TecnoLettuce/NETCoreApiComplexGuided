...
{
    public class TestLikeServiceGetAllLikesByPostIdAsync
    {
        ...
        [Fact]
        public void TestGetAllLikesByPostIdAsyncReturnSomething()
        {
            ...
            Task<IEnumerable<LikeReaderDTO>> ReturnedFromService = likeService.GetAllLikesByPostIdAsync(0);
